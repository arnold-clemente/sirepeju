...
const IndexReserva = () => {
    ...
    const handlePru = (e, row) => {
        e.preventDefault();
        const entidad = row.entidad.replace(/ /g, '_');
        console.log(entidad)
    }
                    ...
                    {row.estado === 1
                        ...
                        : <div className='d-flex flex-row justify-content-start'>
                            {row.fecha_entrega
                                ...
                                : <button onClick={(e) => handlePassword(e, row)} className="button_download"><i className="fa-solid fa-check"></i></button>
                            }
                        </div>
                    }

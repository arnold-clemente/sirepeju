...
const SelectOtorgacionArchivados = ({ registro, modal, close }) => {
        ...
        <Document>
                        <Page size="letter" style={styles.body}>
                            <View style={styles.contenedor_logo}>
                                ...
                                <Text style={styles.prueba}>TRÁMITES EN PROCESO DE OTORGACIÓN</Text>
...
export default SelectOtorgacionArchivados

...
import { createInformeMod } from 'api/modificacionOtorgacionApi';

const ModalInformeMod = ({ registrorModal, openRegistrorModal, closeRegistrorModal, registro, handleInputChange }) => {
...
export default ModalInformeMod

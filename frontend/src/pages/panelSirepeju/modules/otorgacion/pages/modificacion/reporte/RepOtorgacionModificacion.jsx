...
const RepOtorgacionModificacion = ({ otorgacion, fundadores, modal, close }) => {
    let fecha_esp = ''

    if (otorgacion.fecha_envio) {
        const date = new Date(otorgacion.fecha_envio);
...
export default RepOtorgacionModificacion

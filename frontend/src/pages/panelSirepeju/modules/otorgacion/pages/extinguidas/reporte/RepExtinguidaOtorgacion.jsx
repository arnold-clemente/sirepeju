...
const RepExtinguidaOtorgacion = ({ otorgacion, fundadores, modal, close }) => {
  ...
  useEffect(() => {
    ...
    <View style={styles.tableRow}> 
        ...
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{otorgacion.nota_extincion}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{otorgacion.fecha_extenion}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{otorgacion.extincion}</Text> 
        </View> 
        </View>
      </View>
       {/* final de la tabla */}
...
export default RepExtinguidaOtorgacion

...
import RepExtinguidaOtorgacion from './reporte/RepExtinguidaOtorgacion';

import { useMutation } from 'react-query';
import { getOtorgacion } from 'api/otorgacionesApi';

const ExtinguidaOtorgacionShow = ({ registro, modalRegistro, closeRegistro }) => {
                        ...
                        <div className="card m-2">
                            ...
                            <div className="card-body">
                                ...
                                <div className="row border-bottom p-1">
                                    ...
                                    <div className="col-md-3 "><h2>{otorgacion.nota_extincion}</h2></div>
                                    <div className="col-md-3 fw-bold ">Fecha de extinción</div>
                                    <div className="col-md-3 "><h2>{otorgacion.fecha_extenion}</h2></div>
...
export default ExtinguidaOtorgacionShow

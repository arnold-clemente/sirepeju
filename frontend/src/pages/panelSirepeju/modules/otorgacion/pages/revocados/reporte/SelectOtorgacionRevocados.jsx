...
const SelectOtorgacionRevocados = ({ registro, modal, close }) => {
          ...
          <Document>
            <Page size="letter" style={styles.body}>
              <View style={styles.contenedor_logo}>
                ...
                <Text style={styles.prueba}>LISTA DE OTORGACIONES REVOCADAS</Text>
...
export default SelectOtorgacionRevocados

...
const SelectOtorgacionPersonalidades = ({ registro, modal, close }) => {
          ...
          <Document>
            <Page size="letter" style={styles.body}>
              <View style={styles.contenedor_logo}>
                ...
                <Text style={styles.prueba}>PERSONALIDADES JURÍDICAS SIN FINES DE LUCRO QUE DESARROLLAN ACTIVIDADES EN MÁS DE UN DEPARTAMENTO</Text>
                  ...
                  ? registro.map((row, index) => {
                    return (
                      <View style={styles.tableRow} key={row.id}>
                        ...
                        <View style={styles.tableCol}>
                          <Text style={styles.tableCell}>{row.personalidad_juridica} - {row.sigla}</Text>
                        </View>
                      
                        <View style={styles.tableCol}>
                          <Text style={styles.tableCell}>{row.resolucion_ministerial}</Text>
                        </View>
                        <View style={styles.tableCol}>
                          <Text style={styles.tableCell}>{row.fecha_resolucion}</Text>
                        </View>
                      </View>
                    )
                  })
...
export default SelectOtorgacionPersonalidades

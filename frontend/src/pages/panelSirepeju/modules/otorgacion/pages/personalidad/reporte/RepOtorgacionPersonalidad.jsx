...
const RepOtorgacionPersonalidad = ({ otorgacion, fundadores, modal, close }) => {
  ...
  useEffect(() => {
    ...
    <View style={styles.tableRow}> 
        ...
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{otorgacion.resolucion_ministerial}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{otorgacion.fecha_resolucion}</Text> 
        </View>
        <View style={styles.tableCol}> 
...
export default RepOtorgacionPersonalidad

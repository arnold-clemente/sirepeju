              ...
              ? <div className='dropdown'>
                ...
                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  {permisos.includes('gobernacion.update')
                    ? <li>
                      <Link to={`/admin/usuario-gobernaciones/editar/${row.id}`} className="button_edit_table dropdown-item">
      ...
      <div className='container-fluid d-flex flex-row md:flex-columns my-4'>
        ...
        <div>
          {permisos.includes('gobernacion.store')
            ? <Link to="/admin/usuario-gobernaciones/crear" className='button_green'>
              <span>AÑADIR</span>

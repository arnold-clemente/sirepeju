                    ...
                    <Document>
                        <Page size="letter" style={styles.body}>
                            <View style={styles.contenedor_logo}>
                                ...
                                <Text style={styles.prueba}>LISTA DE RESPONSABLES POR GOBERNACIÓN AL SISTEMA DE REGISTRO DE PERSONALIDADES JURÍDICAS</Text>
                            ...
                            <View style={styles.table}>
                                ...
                                <View style={styles.tableRow}>
                                    ...
                                    <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                                        <Text style={{ ...styles.tableCell, ...styles.textoBlanco }}>RESPONSABLE ASIGNADO</Text>
                                    </View>
                                    <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>

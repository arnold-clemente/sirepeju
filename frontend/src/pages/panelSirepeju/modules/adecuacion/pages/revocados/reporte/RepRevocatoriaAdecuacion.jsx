...
const RepRevocatoriaAdecuacion = ({ adecuacion, fundadores, modal, close }) => {
    ...
    <View style={styles.tableRow}> 
        ...
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{adecuacion.nota_revocatorio}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{adecuacion.fecha_revocatoria}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{adecuacion.revocatoria}</Text> 
        </View> 
        </View>
      </View>
       {/* final de la tabla */}
...
export default RepRevocatoriaAdecuacion

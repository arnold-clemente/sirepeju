...
const SelectRevocadosAdecuacion = ({ registro, modal, close }) => {
          ...
          <Document>
            <Page size="letter" style={styles.body}>
              ...
              <View style={styles.contenedor}>
                <Text style={styles.title}>PERSONALIDADES JURÍDICAS SIN FINES DE LUCRO REVOCADAS</Text>
              </View>
              ...
              <View style={styles.table}>
                ...
                <View style={styles.tableRow}>
                  ...
                  <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                    <Text style={{ ...styles.tableCell, ...styles.textoBlanco }}>FECHA DE REVOCACIÓN</Text>
                  </View>
                </View>
                {/* fila 2 */}
                  ...
                  ? registro.map((row, index) => {
                    return (
                      <View style={styles.tableRow} key={row.id}>
                        ...
                        <View style={styles.tableCol}>
                          <Text style={styles.tableCell}>aqui la fecha de revocacion</Text>
                        </View>
                      </View>
                    )
                  })
...
export default SelectRevocadosAdecuacion

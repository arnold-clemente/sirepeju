...
const SelectAdecuacionArchivados = ({ registro, modal, close }) => {
                    ...
                    <Document>
                        <Page size="letter" style={styles.body}>
                            <View style={styles.contenedor_logo}>
                                ...
                                <Text style={styles.prueba}>TRÁMITES EN PROCESO DE ADECUACIÓN</Text>
                                    ...
                                    ? registro.map((row, index) => {
                                        return (
                                            <View style={styles.tableRow} key={row.id}>
                                                ...
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>{row.cite_informe_preliminar}</Text>
                                                </View>
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>ARCHIVADO</Text>
                                                </View>
                                            </View>
                                        )
                                    })
                            ...
                            <View style={styles.content}>
                                ...
                                <Text style={styles.dato}>{"\n"}El contenido de este documento esta extraido del sistema SIREPEJU 
                                (Sistema de Registro de Personalidades Juridícas).</Text>
...
export default SelectAdecuacionArchivados

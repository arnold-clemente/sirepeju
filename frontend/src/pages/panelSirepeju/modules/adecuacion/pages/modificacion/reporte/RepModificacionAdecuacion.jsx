...
const RepModificacionAdecuacion = ({ adecuacion, fundadores, modal, close }) => {
            ...
            <PDFViewer style={styles.main}>
                    <Document>
                        ...
                        <Image style={styles.logo} src={logo} />
                                ...
                                <Text style={styles.prueba}>TRÁMITE DE MODIFICACIÓN</Text>
    ...
    <View style={styles.tableRow}> 
        ...
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>Código origen</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>Código asignado</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>informe</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
...
export default RepModificacionAdecuacion

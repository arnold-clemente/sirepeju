...
const SelectModificacionAdecuacion = ({ registro, modal, close }) => {
                ...
                <Document>
                        <Page size="letter" style={styles.body}>
                            <View style={styles.contenedor_logo}>
                                ...
                                <Text style={styles.prueba}>LISTA DE TRÁMITES EN MODIFICACIÓN</Text>
                            ...
                            <View style={styles.table}>
                                ...
                                <View style={styles.tableRow}>
                                    ...
                                    <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                                        <Text style={{ ...styles.tableCell, ...styles.textoBlanco }}>Fecha de inicio de modificación</Text>
                                    </View>
                                    <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                                        ...
                                        return (
                                            <View style={styles.tableRow} key={row.id}>
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>{row.modificacion}</Text>
                                                </View>
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>{row.fecha_modificacion}</Text>
                                                </View>
                                                <View style={styles.tableCol}>
...
export default SelectModificacionAdecuacion

...
import { createSeguimientoMod } from 'api/modificacionAdecuacionApi';

const ModalSeguimientoAde = ({ registrorModal, openRegistrorModal, closeRegistrorModal, registro, handleInputChange }) => {
    ...
    const addSeguimiento = useMutation({
        mutationFn: createSeguimientoMod,
        onSuccess: (response) => {
            setLoading(false);
...
export default ModalSeguimientoAde

...
import RepCaducadoAdecuacion from './reporte/RepCaducadoAdecuacion';

const ShowAdecuacionCaducado = ({ registro, modalRegistro, closeRegistro }) => {
                        ...
                        <div className='container-fluid d-flex justify-content-end gap-1'>
                            ...
                            {adecuacion.id != 0
                                ? <>
                                    ...
                                    <div className='absolute'>
                                        <RepCaducadoAdecuacion modal={modalpdf} close={closeModalpdf}
...
export default ShowAdecuacionCaducado

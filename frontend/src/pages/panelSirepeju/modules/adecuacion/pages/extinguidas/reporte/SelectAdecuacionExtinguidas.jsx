          ...
          <Document>
            <Page size="letter" style={styles.body}>
              <View style={styles.contenedor_logo}>
                ...
                <Text style={styles.prueba}>PERSONALIDADES JURÍDICAS SIN FINES DE LUCRO EXTINGUIDAS</Text>
                  ...
                  ? registro.map((row, index) => {
                    return (
                      <View style={styles.tableRow} key={row.id}>
                        ...
                        <View style={styles.tableCol}>
                          <Text style={styles.tableCell}>{row.nota_extincion}</Text>
                        </View>
                        <View style={styles.tableCol}>
                          <Text style={styles.tableCell}>{row.fecha_extenion}</Text>
                        </View>
                      </View>
                    )
                  })
...
export default SelectAdecuacionExtinguidas

...
import RepAdecuacionExtinguida from './reporte/RepAdecuacionExtinguida';

import { useMutation } from 'react-query';
import { getAdecuacion } from 'api/adecuacionApi';
import ViewPdf from 'components/ViewPdf';

const ShowAdecuacionExtinguida = ({ registro, modalRegistro, closeRegistro }) => {
    ...
    return (
        <>
            <ModalDiv isOpen={modalRegistro} closeModal={closeRegistro} title={'PERSONALIDAD JURÍDICAS EXTINGUIDAS'}>
                {!cargando
                    ? (<div className="container-fluid">
                        ...
                        <div className='container-fluid d-flex justify-content-end gap-1'>
                            {adecuacion.alfanumerico
                                ? <>
                                    <button className='btn btn-danger' onClick={openAlfanumerico} >
                                        ...
                                        <span className='mx-1'>AImprimir Alfanúmerico</span>
                                    </button>
                            ...
                            {adecuacion.id != 0
                                ? <>
                                    ...
                                    <div className='absolute'>
                                        <RepAdecuacionExtinguida modal={modalpdf} close={closeModalpdf}
                        ...
                        <div className="card m-2">
                            ...
                            <div className="card-body">
                                ...
                                <div className="row border-bottom p-1">
                                    <div className="col-md-3 fw-bold ">Resolución Ministerial de extinción:</div>
                                    <div className="col-md-3 "><h2>{adecuacion.nota_extincion}</h2></div>
                                    <div className="col-md-3 fw-bold ">Fecha de extinción</div>
                                    <div className="col-md-3 "><h2>{adecuacion.fecha_extenion}</h2></div>
...
export default ShowAdecuacionExtinguida

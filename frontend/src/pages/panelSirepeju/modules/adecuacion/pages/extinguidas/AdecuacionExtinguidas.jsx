...
import SelectAdecuacionExtinguidas from './reporte/SelectAdecuacionExtinguidas';

const AdecuacionExtinguidas = () => {
    ...
    return (
        <>
            ...
            <ShowAdecuacionExtinguida registro={adecuacionShow} modalRegistro={modalAdecuacion} closeRegistro={closeAdecuacion} />
            <SelectAdecuacionExtinguidas registro={selectedRows} modal={selectpdf} close={closeSelectpdf} />
            <Banner text="ADECUACIONES EXTINGUIDAS" />
            ...
            <div className='table-responsive'>
                <DataTable
                    title='TABLA ADECUACION EXTINGUIDSA'
                    columns={columns}
...
export default AdecuacionExtinguidas

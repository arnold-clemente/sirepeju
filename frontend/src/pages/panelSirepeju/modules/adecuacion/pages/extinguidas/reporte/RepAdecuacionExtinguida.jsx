...
const RepAdecuacionExtinguida = ({ adecuacion, fundadores, modal, close }) => {
                ...
                <PDFViewer style={styles.main}>
                    <Document>
                        ...
                        <View style={styles.contenedor_logo}>
                            ...
                            <Text style={styles.prueba}>PERSONALIDAD JURÍDICA EXTINGUIDA</Text>
                        
                                <Text style={styles.prueba2}>NATURALEZA:</Text>
                                <Text style={styles.title}>{adecuacion.naturaleza}</Text>
                                
                                <Text style={styles.prueba2}>ENTIDAD:</Text>
                                <Text style={styles.title}>{adecuacion.personalidad_juridica}</Text>
                              
                                <Text style={styles.prueba2}>SIGLA:</Text>
                                <Text style={styles.title}> {adecuacion.sigla}</Text>
                                <Text style={styles.prueba2}>DOMICILIO LEGAL:</Text>
                                <Text style={styles.title}> {adecuacion.domicilio_legal}</Text>
                                <Text style={styles.prueba2}>OBJETO:</Text>
                                <Text style={styles.title}>{adecuacion.objeto}{"\n"}{"\n"}</Text>
    ...
    <View style={styles.tableRow}> 
        ...
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>Resolución ministerial de extinción</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>Fecha de resolución ministerial de extinción</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        ...
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{adecuacion.nota_extincion}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{adecuacion.fecha_extenion}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{adecuacion.extincion}</Text> 
        </View> 
        </View>
      </View>
       {/* final de la tabla */}
       ...
       <Text style={styles.prueba2}>{"\n"}CÓDIGO UNICO:</Text>
                                <Text style={styles.title}>{adecuacion.alfanumerico}{"\n"}</Text>
...
export default RepAdecuacionExtinguida

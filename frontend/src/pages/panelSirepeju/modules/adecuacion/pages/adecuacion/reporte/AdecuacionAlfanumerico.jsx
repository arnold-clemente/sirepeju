                    ...
                    <Document>
                        ...
                        <View style={styles.contenedor_logo}>
                            ...
                            <View style={styles.contenedor}>
                                <Text style={styles.title}>CODÍGO ÚNICO </Text>
                                <Text style={styles.title}>[Alfanumérico]</Text>
                            </View>
                            <View style={styles.lista}>
                                <Text style={styles.tipo}>CÓDIGO ALFANUMÉRICO: </Text>
                                <Text style={styles.dato}>{registro.alfanumerico}</Text>
                            </View>
                            <View style={styles.lista}>
                                <Text style={styles.tipo}>NÚMERO DE REGISTRO: </Text>
                                <Text style={styles.dato}>{registro.codigo_adecuacion}</Text>
                            </View>
                            <View style={styles.lista}>
                                <Text style={styles.tipo}>NOMBRE DE LA ENTIDAD: </Text>

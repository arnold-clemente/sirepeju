...
const RepProcesoAdecuacion = ({ adecuacion, fundadores, modal, close }) => {
                    ...
                    <Document>
                        <Page size="letter" style={styles.body}>
                            ...
                            <View style={styles.contenedor_logo}>
                                ...
                                <Text style={styles.title}>TRÁMITE DE SOLICITUD DE ADECUACIÓN DE PERSONALIDAD JURÍDICA</Text>
                                <Text style={styles.prueba2}>REPRESENTANTE LEGAL:</Text>
                                <Text style={styles.title}>{adecuacion.representante}</Text>
                                ...
                                <Text style={styles.title}>{adecuacion.personalidad_juridica} - {adecuacion.sigla}</Text>
 ...
 <View style={styles.table}>
    ...
    <View style={styles.tableRow}> 
        ...
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{adecuacion.domicilio_legal}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        ...
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{adecuacion.cite_informe_preliminar}</Text> 
        </View> 
        </View>
      </View>
       {/* final de la tabla */}
...
export default RepProcesoAdecuacion

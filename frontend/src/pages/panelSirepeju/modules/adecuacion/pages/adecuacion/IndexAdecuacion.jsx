...
const IndexAdecuacion = () => {
  ...
  const handleRegistroFinal = (e, row) => {
    ...
    const concatenar = row.codigo_adecuacion;
              ...
              <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                ...
                <li>
                  {row.miembros_fundador == 'sin asignar' && permisos.includes('adecuacion.personalidad')
                    ? <Link to={`/admin/adecuaciones/${row.id}/fundadores`} className="button_edit_table">
      ...
      <div className='container-fluid d-flex flex-row md:flex-columns my-4'>
        ...
        <div>
          {permisos.includes('adecuacion.store')
            ? <Link to="/admin/adecuaciones/crear" className='btn button_green'>
              <span>AÑADIR</span>

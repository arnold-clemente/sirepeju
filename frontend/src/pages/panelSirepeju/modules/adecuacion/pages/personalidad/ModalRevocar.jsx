...
import { createRevocatoria } from 'api/adecuacionApi';

const ModalRevocar = ({ registrorModal, openRegistrorModal, closeRegistrorModal, registro, handleInputChange }) => {

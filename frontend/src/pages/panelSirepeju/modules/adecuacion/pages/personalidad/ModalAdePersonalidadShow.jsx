...
const ModalAdePersonalidadShow = ({ registro, modalRegistro, closeRegistro }) => {
    ...
    return (
        <>
            <ModalDiv isOpen={modalRegistro} closeModal={closeRegistro} title={'PERSONALIDAD JURÍDICA'}>
                {!cargando
                        ...
                        <div className="card m-2">
                            ...
                            <div className="card-body">
                                ...
                                <div className="row border-bottom p-1">
                                    ...
                                    <div className="col-md-3 "><h2>{adecuacion.resolucion_ministerial}</h2></div>
                                    <div className="col-md-3 fw-bold ">Fecha de resolución ministerial</div>
                                    <div className="col-md-3 "><h2>{adecuacion.fecha_resolucion}</h2></div>

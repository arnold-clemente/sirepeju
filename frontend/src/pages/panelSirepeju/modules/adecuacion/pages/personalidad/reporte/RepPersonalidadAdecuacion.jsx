...
const RepPersonalidadAdecuacion = ({ adecuacion, fundadores, modal, close }) => {
    ...
    <View style={styles.tableRow}> 
        ...
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>BENEFICIARIO FINAL</Text> 
        </View> 
        </View> 
        {/* fila 2 */}
        <View style={styles.tableRow}> 
        ...
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{adecuacion.resolucion_ministerial}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{adecuacion.fecha_resolucion}</Text> 
        </View>
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{fundadores.length > 0
                 ...
                 {/* final de la tabla */}              
                 <Text style={styles.prueba2}>{"\n"}CÓDIGO UNICO DE ADECUACIÓN:</Text>
...
export default RepPersonalidadAdecuacion

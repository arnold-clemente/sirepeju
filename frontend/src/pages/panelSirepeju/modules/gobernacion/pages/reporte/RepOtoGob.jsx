...
const RepOtoGob = ({ registro, fundadores, modal, close }) => {
  ...
  // const qrCodeDataUri = qrCodeCanvas.toDataURL('image/jpg', 0.3);
        ...
        />
            ...
            <PDFViewer style={styles.main}>
              ...
              <Image style={styles.logo} src={logo} />
                ...
                <Text style={styles.prueba}>PERSONALIDAD JURÍDICA OTORGADA POR:</Text>
                <Text style={styles.title}>{registro.institucion}</Text>
    ...
    <View style={styles.tableRow}> 
        ...
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>NOMBRE DE LA PERSONA COLECTIVA</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>SIGLA</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>RESOLUCIÓN ADMINISTRATIVA</Text> 
        </View> 
        </View> 
        {/* fila 2 */}
        <View style={styles.tableRow}> 
        ...
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{registro.nombre_persona_colectiva}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{registro.sigla}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{registro.resolucion}</Text> 
        </View> 
        </View>
      </View>
       {/* final de la tabla */}
    ...
    <View style={styles.tableRow}> 
        ...
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>DIRECTORIO </Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>FECHA DE R.A.</Text> 
        </View> 
        </View> 
        {/* fila 2 */}
        <View style={styles.tableRow}> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{registro.domicilio_legal}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{registro.objeto}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{registro.institucion}</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}>{registro.fecha_resolucion}</Text> 
        </View> 
        </View>
      </View>
       {/* final de la tabla */}

...
const RepOtoGob = ({ registro, fundadores, modal, close }) => {
    ...
    if (registro.fecha_resolucion) {
        const date = new Date(registro.fecha_resolucion);
        ...
        <>
            <Modal isOpen={modal} closeModal={close}>
              ...
              <View style={styles.contenedor}>
                <Text style={styles.title}>PERSONALIDAD JURÍDICA OTORGADA POR LOS  GOBIERNOS AUTONÓMOS DEPARTAMENTALES</Text>
              </View>
    ...
    <View style={styles.tableRow}> 
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>FECHA DE RESOLUCIÓN ADMINISTRATIVA</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        ...
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}></Text> 
        </View> 
        </View> 
        {/* fila 2 */}
        <View style={styles.tableRow}> 
        ...
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}> aqui los miembros fundadores</Text> 
        </View> 
        <View style={styles.tableCol}> 
        <Text style={styles.tableCell}></Text> 
        </View> 

            ...
            ? <div className='dropdown'>
              ...
              <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                {permisos.includes('otorgacion.gobernacion.update')
                  ? <li>
                    <Link to={`/admin/otorgaciones-gobernaciones/editar/${row.id}`} className="button_edit_table">
      ...
      <div className='container-fluid d-flex flex-row md:flex-columns my-4'>
        ...
        <div>
          {permisos.includes('otorgacion.gobernacion.store')
            ? <Link to="/admin/otorgaciones-gobernaciones/crear" className='btn button_green'>
              <span>AÑADIR</span>

...
const SelectHomonimia = ({ registro, modal, close }) => {
                    ...
                    <Document>
                        <Page size="letter" style={styles.body}>
                            <View style={styles.contenedor_logo}>
                                ...
                                <Text style={styles.prueba}>LISTA DE SOLICITUDES DE RESERVA DE NOMBRE OBSERVADAS</Text>
...
export default SelectHomonimia

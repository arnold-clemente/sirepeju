...
const SelectReservados = ({ registro, modal, close }) => {
                    ...
                    <Document>
                        <Page size="letter" style={styles.body}>
                            ...
                            <View style={styles.contenedor}>
                                <Text style={styles.prueba}>LISTA DE PERSONAS COLECTIVAS CON CERTIFICADO DE REGISTRO Y VERIFICACIÓN DE NOMBRE</Text>
                            </View>
...
export default SelectReservados

                    ...
                    <Document>
                        <Page size="letter" style={styles.body}>
                            ...
                            <View style={styles.contenedor}>
                                <Text style={styles.prueba}>LISTA DE REGISTRO DE RESERVA DE NOMBRE QUE NO PRESENTARON SUS REQUISITOS (DADOS DE BAJA)</Text>
                            </View>
                            <Text style={styles.title}>UNIDAD DE PERSONALIDADES JURÍDICAS</Text>

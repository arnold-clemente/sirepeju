            ...
            cell: (row) => (
                ...
                <div className='d-flex flex-row justify-content-start gap-1'>
                    ...
                    {permisos.includes('reserva.update')
                        ? <Link to={`/admin/reservas/editar/${row.id}`} className="button_edit"><i className="fa-solid fa-pen-to-square"></i><span>Editar</span></Link>
                        : null
                    }
            ...
            <div className='container-fluid d-flex flex-row md:flex-columns my-4'>
                ...
                <div>
                    {permisos.includes('reserva.store')
                        ? <Link to="/admin/reservas/crear" className='btn button_green'>
                            <span>AÑADIR</span>

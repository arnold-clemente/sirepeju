...
const ModalTramite = ({ registro, modal, closeModal }) => {
    useEffect(() => {
        if (registro.tipo == 2) {
            setLoading(true);
                            ...
                            <div className='buscados_modal_body_content'>
                                ...
                                <div className='container-fluid'>
                                    <div className='row g-3'>
                                        <h3 className='fs-6'>
                                            <span>El trámite se encuentra en</span>
                                            <span>{' ' + informe.descripcion + ' el: ' + informe.fecha + ', '}</span>
                                            <span>si necesitas mas informción contactarse con la unidad de personalidades juridicas Viceministerio de autonomias ubicadas en la av. ecuador</span>
                                        </h3>
                                    </div>

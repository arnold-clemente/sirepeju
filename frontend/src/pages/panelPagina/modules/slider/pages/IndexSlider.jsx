...
import { getSliders, destroySlider } from 'api/panel/sliderApi';
...
const IndexSlider = () => {
    ...
    const { isLoading, data: registros, isError, error } = useQuery({
        queryKey: ['panel_sliders'],
        queryFn: getSliders,
        select: sliders => sliders.sort((a, b) => b.id - a.id)
    })
    ...
    const dropSlider = useMutation({
        mutationFn: destroySlider,
        onSuccess: (response) => {
                    ...
                    <div className='container-fluid d-flex flex-row gap-1'>
                        <div className='dropdown'>
                            <div className='d-flex gap-2'>
                                <Link to={`/panel/sliders/editar/${row.id}`} className="button_edit dropdown-item">
    ...
    return (
        <div>
            ...
            <Banner text="LISTA DE SLIDER DE PORTADA" />
            <div className='container-fluid d-flex flex-row md:flex-columns my-4'>
                ...
                <div>
                    <Link to="/panel/sliders/crear" className='button_green'>
                        <span>AÑADIR</span>

...
import { getVideos, destroyVideo } from 'api/panel/videoApi';
...
const IndexVideo = () => {
    ...
    const { isLoading, data: registros, isError, error } = useQuery({
        queryKey: ['panel_videos'],
        queryFn: getVideos,
        select: videos => videos.sort((a, b) => b.id - a.id)
    })
    ...
    const dropVideo = useMutation({
        mutationFn: destroyVideo,
        onSuccess: (response) => {
                    ...
                    <div className='container-fluid d-flex flex-row gap-1'>
                        <div className='dropdown'>
                            <div className='d-flex gap-2'>
                                <Link to={`/panel/videos/editar/${row.id}`} className="button_edit dropdown-item">
    ...
    return (
        <div>
            ...
            <div className='container-fluid d-flex flex-row md:flex-columns my-4'>
                ...
                <div>
                    <Link to="/panel/videos/crear" className='button_green'>
                        <span>AÑADIR</span>

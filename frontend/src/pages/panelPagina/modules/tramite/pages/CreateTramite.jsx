...
import { createTramite } from 'api/panel/tramiteApi';
...
const CreateTramite = () => {
    ...
    return (
        <>
            ...
            <Banner text="CREACIÓN DE NUEVO TRAMITE" />

...
const RepCaducadoOtorgacion = ({ otorgacion, fundadores, personalidad, modal, close }) => {
    let fecha_esp = ''
                ...
                <PDFViewer style={styles.main}>
                    ...
                    <View style={styles.contenedor_logo}>
                            ...
                            <View style={styles.contenedor}>
                                <Text style={styles.title}>TRAMÍTE DE OTORGACIÓN</Text>
                                <Text Style={styles.title}>ESTADO: ARCHIVADO</Text>
                            </View>  
    ...
    <View style={styles.tableRow}> 
        ...
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>CÓIGO</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
...
export default RepCaducadoOtorgacion

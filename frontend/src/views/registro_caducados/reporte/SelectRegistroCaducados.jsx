...
const SelectRegistroCaducados = ({ registro, modal, close }) => {
                    ...
                    <Document>
                        <Page size="letter" style={styles.body}>
                            ...
                            <View style={styles.contenedor}>
                                <Text style={styles.prueba}>REGISTRO DE LAS PERSONAS COLECTIVAS SIN PRESENTACIÓN DE REQUISITOS (DADOS DE BAJA)</Text>
                            </View>
                            ...
                            <View style={styles.table}>
                                ...
                                <View style={styles.tableRow}>
                                    ...
                                    <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                                        <Text style={{ ...styles.tableCell, ...styles.textoBlanco }}>CELULAR DEL SOLICITANTE</Text>
                                    </View>
                                </View>
                                {/* fila 2 */}
                                {registro.length > 0
                                    ? registro.map((row, index) => {
                                        return (
                                            <View style={styles.tableRow} key={row.id}>
                                                ...
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>{row.representante}</Text>
                                                </View>
                                                <View style={styles.tableCol}>
                            ...
                            <View style={styles.content}>
                                ...
                                <Text style={styles.dato}>{"\n"}Las personas colectivas solicitantes no presentaron su trámite de otorgación en el plazo de 60 días
                                    razón por lo cual se procedió a su eliminación de sistema de registro de personalidades juridícas
                                    (SIREPEJU) conforme al Art.9 del D.S. Nº 1597</Text>
...
export default SelectRegistroCaducados

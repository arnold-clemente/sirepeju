...
import EstatutoModAde from './reporte/EstatutoModAde';

const ModalShowAdecuacion = ({ showRegistro, modalRegistro, closeRegistro }) => {
            ...
            <div className="container-fluid">
                ...
                {showRegistro.registro_persona_adecuacion
                    ? (<>
                        ...
                        <EstatutoModAde registro={showRegistro} modal={modalEstatuto} close={closeEstatuto} src={url} />
                    </>)
                    : ''}

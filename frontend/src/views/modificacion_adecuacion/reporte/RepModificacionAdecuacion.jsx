...
const RepModificacionAdecuacion = ({ adecuacion, fundadores, personalidad, modal, close }) => {
    let fecha_esp = ''
                    ...
                    <Document>
                        ...
                        <View style={styles.contenedor_logo}>
                            ...
                            <View style={styles.contenedor}>
                                <Text style={styles.title}>PERSONALIDAD JURÍDICA SIN FIN DE LUCRO QUE DESARROLLA ACTIVIDADES EN MAS DE UN DEPARTAMENTO EN ETAPA DE MODIFICACIÓN</Text>
    ...
    <View style={styles.tableRow}> 
        ...
        <Text style={styles.tableCell}>aqui es el codigo mpj</Text> 
        </View> 
        <View style={styles.tableCol}> 

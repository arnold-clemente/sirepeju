...
const RepProcesoAdecuacion = ({ adecuacion, fundadores, personalidad, modal, close }) => {
    let fecha_esp = ''
                    ...
                    <Document>
                        <Page size="letter" style={styles.body}>
                            ...
                            <View style={styles.contenedor}>
                                ...
                                <Text style={styles.title}>REPORTE DE LOS TRÁMITES DE ADECUACÍON</Text>
                            ...
                            <View style={styles.table}>
                                ...
                                <View style={styles.tableRow}>
                                    ...
                                    <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                                        <Text style={{ ...styles.tableCell, ...styles.textoBlanco }}>REPRESENTANTE LEGAL</Text>
                                    </View>
                                </View>
                                {/* fila 2 */}
                                <View style={styles.tableRow}>
                                    ...
                                    <View style={styles.tableCol}>
                                        <Text style={styles.tableCell}>{adecuacion.representante}</Text>
                                    </View>
                                </View>

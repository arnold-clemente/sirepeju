...
const SelectModificaciones = ({ registro, modal, close }) => {
                    ...
                    <Document>
                        ...
                        <View style={styles.contenedor_logo}>
                            ...
                            <View style={styles.contenedor}>
                                <Text style={styles.title}>LISTA DE LAS PERSONALIDADES JURÍDICAS  CON TRÁMITE DE MODIFICACIÓN</Text>
                            </View>
    ...
    <View style={styles.tableRow}> 
        ...
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>CANTIDAD</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>CÓDIGO MPJ</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>FECHA DE MODIFICACIÓN</Text> 
        </View>
        <View style={{ ...styles.tableCol, ...styles.celdaColorida}}> 
        <Text style={{...styles.tableCell, ...styles.textoBlanco}}>TIPO DE TRÁMITE DE ORIGEN</Text> 
        </View> 
        </View> 
        {/* fila 2 */}
        {registro.length > 0
                ...
                <View style={styles.tableCol}> 
                <Text style={styles.tableCell}>{row.codigo_modificacion}</Text> 
                </View> 
                <View style={styles.tableCol}> 
...
export default SelectModificaciones

...
import { createExtinguida } from '../../api/otorgacionesApi';

const ModalExtinguirOtorgacion = ({ registrorModal, openRegistrorModal, closeRegistrorModal, registro, handleInputExtinto}) => {
    ...
    const addSeguimiento = useMutation({
        ...
        onSuccess: (response) => {
            ...
            if (response.status === true) {
                ...
                queryClient.invalidateQueries('otorgacion_extinguidas')
...
export default ModalExtinguirOtorgacion

...
const SelectOtorgaciones = ({ registro, modal, close }) => {
                    ...
                    <Document>
                        <Page size="letter" style={styles.body}>
                            ...
                            <View style={styles.contenedor}>
                                <Text style={styles.title}>LISTA DE PERSONAS COLECTIVAS SEGUN NATURALEZA EN PROCESO DE OTORGACIÓN</Text>
                            </View>
...
export default SelectOtorgaciones

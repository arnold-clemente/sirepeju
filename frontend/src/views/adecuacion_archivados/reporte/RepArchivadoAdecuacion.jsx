...
const RepArchivadoAdecuacion = ({ adecuacion, fundadores, personalidad, modal, close }) => {
    let fecha_esp = ''
                    ...
                    <Document>
                        ...
                        <View style={styles.contenedor_logo}>
                            ...
                            <View style={styles.contenedor}>
                                <Text style={styles.title}>TRAMÍTE DE  ADECUACIÓN ARCHIVADA </Text>
                            </View>  
    ...
    <View style={styles.tableRow}> 
       ...
       {/* final de la tabla */}
                            ...
                            <View style={styles.contenedor}>
                                ...
                                <Text style={styles.title}>Archivado de Adecuacion</Text>

...
import { color_otorgacion, estadoAdecuacion } from './Estados';

const VerificacionAdecuacion = ({ registro, modal, close }) => {

    const { adecuacion_id } = registro;
                ...
                {cargando
                    ...
                    : <>
                        <div className='d-flex justify-content-center'>
                            <span className={color_otorgacion[adecuacion.estado] + ' white_modal estados_rounded'}>{estadoAdecuacion[adecuacion.estado]}</span>
                        </div>
...
export default VerificacionAdecuacion

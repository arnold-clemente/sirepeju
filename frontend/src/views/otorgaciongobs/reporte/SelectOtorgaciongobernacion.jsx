...
const SelectOtorgaciongobernacion = ({ registro, modal, close }) => {
        ...
        />
            ...
            <Modal isOpen={modal} closeModal={close}>
              ...
              <View style={styles.contenedor}>
                <Text style={styles.prueba}>LISTA DE PERSONERÍAS JURÍDICAS OTORGADAS POR GOBIERNOS AUTÓNOMOS DEPARTAMENTALES</Text>
              </View>
              <Text style={styles.title}>Unidad de Personalidades Juridícas</Text>
                ...
                <View style={styles.tableRow}>
                  <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                    <Text style={{ ...styles.tableCell, ...styles.textoBlanco }}>INSTITUCIÓN</Text>
                  </View>
                  <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                    <Text style={{ ...styles.tableCell, ...styles.textoBlanco }}>NOMBRE DE PERSONERÍA COLECTIVA</Text>
                  </View>
                  <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                  ...
                  ? registro.map((row, index) => {
                    return (
                      <View style={styles.tableRow} key={row.id}>
                        ...
                        <View style={styles.tableCol}>
                          <Text style={styles.tableCell}>{row.nombre_persona_colectiva}</Text>
                        </View>
                        <View style={styles.tableCol}>
                          <Text style={styles.tableCell}>{row.sigla}</Text>
                        </View>
                        <View style={styles.tableCol}>
                          <Text style={styles.tableCell}>{row.resolucion}</Text>
                        </View>
                      </View>
                    )
                  })
...
export default SelectOtorgaciongobernacion

...
import { createSeguimientoMod } from '../../api/modificacionOtorgacionApi';

const ModalSeguimientoMod = ({ registrorModal, openRegistrorModal, closeRegistrorModal, registro, handleInputChange }) => {
...
export default ModalSeguimientoMod

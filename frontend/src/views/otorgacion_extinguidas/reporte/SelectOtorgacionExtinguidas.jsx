          ...
          <Document>
            <Page size="letter" style={styles.body}>
              ...
              <View style={styles.contenedor}>
                <Text style={styles.title}>PERSONALIDADES JURÍDICAS EXTINGUIDAS </Text>
              ...
              <View style={styles.table}>
                ...
                <View style={styles.tableRow}>
                  ...
                  <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                    <Text style={{ ...styles.tableCell, ...styles.textoBlanco }}>NOMBRE DE LA PERSONALIDAD JURÍDICA</Text>
                  </View>
                  <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                    <Text style={{ ...styles.tableCell, ...styles.textoBlanco }}>RESOLUCIÓN MINISTERIAL</Text>
                  </View>
                  <View style={{ ...styles.tableCol, ...styles.celdaColorida }}>
                    <Text style={{ ...styles.tableCell, ...styles.textoBlanco }}>FECHA DE LA RESOLUCIÓN MINISTERIAL</Text>
                  </View>
                </View>
                {/* fila 2 */}
                {registro.length > 0
                  ? registro.map((row, index) => {
                    return (
                      <View style={styles.tableRow} key={row.id}>
                        ...
                        <View style={styles.tableCol}>
                          <Text style={styles.tableCell}>{row.fecha_resolucion_ministerial}</Text>
                        </View>
                      </View>
                    )
                  })

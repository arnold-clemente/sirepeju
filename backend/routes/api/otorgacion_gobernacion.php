...
Route::middleware(['auth:sanctum', 'can:otorgacion.gobernaciones'])
->get('/otorgacion-gobernacion/show/{gobernacion}', [OtorgacionGobernacionController::class, 'show'])
...
->put('/otorgacion-gobernacion/update/{gobernacion}', [OtorgacionGobernacionController::class, 'update'])
    ->name('otorgacion.gobernacion.update');

Route::middleware(['auth:sanctum', 'can:otorgacion.gobernacion.destroy'])
->delete('/otorgacion-gobernacion/destroy/{gobernacion}', [OtorgacionGobernacionController::class, 'destroy'])

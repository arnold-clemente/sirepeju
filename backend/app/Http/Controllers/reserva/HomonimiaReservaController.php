...
class HomonimiaReservaController extends Controller
{
    ...
    public function homonimo(Request $request)
    {
        $user_auth = auth()->user();
        $reserva_otorgacion = ReservaOtorgacion::find($request->reserva_id);
        $reserva_otorgacion->estado = 2;
        $reserva_otorgacion->homonimia = $user_auth->id;

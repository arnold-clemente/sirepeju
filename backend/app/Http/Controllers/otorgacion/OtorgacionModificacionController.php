...
class OtorgacionModificacionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $otorgacion->alfanumerico = $request->alfanumerico;
        $otorgacion->estado = 7;
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('estatuto_organico') && $request->hasFile('reglamento_interno')) {
            $rules = array(
                'estatuto_organico' => 'required|file|max:20000|mimes:pdf,docx,doc',
                'reglamento_interno' => 'required|file|max:20000|mimes:pdf,docx,doc',
        ...
        if ($request->hasFile('estatuto_organico')) {
            $modificacion->estatuto_organico = $otorgacion->estatuto_organico;
            $otorgacion->estatuto_organico = $estatuto_organico->store('otorgacion_estatuto_organico', 'public');
        ...
        if ($request->hasFile('reglamento_interno')) {
            $modificacion->reglamento_interno = $otorgacion->reglamento_interno;
            $otorgacion->reglamento_interno = $reglamento_interno->store('otorgacion_reglamento_interno', 'public');

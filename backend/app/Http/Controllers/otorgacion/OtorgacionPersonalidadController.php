    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make(
            ...
            array(
                ...
                'informe_final' => 'required|file|max:20000|mimes:pdf,docx,doc',
                'nota_final' => 'required|file|max:20000|mimes:pdf,docx,doc',
        ...
        $registro = DB::table('otorgacions') //DEBE MOSTRARME TABLAS UNIDAS 
        ->where('id', '=', $otorgacion_id)
        ->update([
            'resolucion_ministerial' => $resolucion_ministerial,
            'fecha_resolucion' => $fecha_resolucion,

...
class AdecuacionModificacionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $adecuacion->alfanumerico = $request->alfanumerico;
        $adecuacion->estado = 7;
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('estatuto_organico')) {
            $modificacion->estatuto_organico = $adecuacion->estatuto_organico;
            $adecuacion->estatuto_organico = $estatuto_organico->store('adecuacion_estatuto_organico', 'public');
        } else {
            $modificacion->estatuto_organico = 'No Modificado';
        }

        if ($request->hasFile('reglamento_interno')) {
            $modificacion->reglamento_interno = $adecuacion->reglamento_interno;
            $adecuacion->reglamento_interno = $reglamento_interno->store('adecuacion_reglamento_interno', 'public');
        } else {
